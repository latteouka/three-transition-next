import { Power0, Power1, Power2, Power3, Expo, Elastic, gsap } from "gsap";
...
export class Tween {
  ...
  static SpringA: any = Elastic.easeOut.config(1, 0.5);
  static SpringB: any = Elastic.easeOut.config(1, 0.75);
